...
/** @var App\lib\wcic_load_hook[] $wp_filter */
global $wp_filter, $wp_actions, $wp_current_filter;

if ( $wp_filter ) {
	$wp_filter = App\lib\wcic_load_hook::build_preinitialized_hooks( $wp_filter );
} else {
	$wp_filter = array();
}
...
function add_filter( $tag, $function_to_add, $priority = 10, $accepted_args = 1 ) {
	...
	if ( ! isset( $wp_filter[ $tag ] ) ) {
		$wp_filter[ $tag ] = new App\lib\wcic_load_hook();
	}
...
function apply_filters( $tag, $value ) {
	...
	// don't pass the tag name to App\lib\wcic_load_hook
	array_shift( $args );
