...
use Symfony\Component\Console\Input\InputInterface,
    ...
    Phpmig\Console\Command\AbstractCommand;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $thisschema         = '$this->schema';
        $thisget            = '$this->get';
        $thisschemacreate   = '$this->schema->create';
        $thisschemadrop     = '$this->schema->drop';
        $argsname           = $input->getArgument('name');
...
class $className extends Migration
{
    ...
    public function up()
    {
        $thisschemacreate( $thistable, function(Blueprint $table){
