								...
								<?php if ( ! empty($tagihan['pending']) ): $i = 1; ?>
									<?php foreach ( $tagihan['pending'] as $key => $value ): $i++
										...
										<tr>
											...
											<td>
												<a href="<?php echo url( null, null, [ 'context' => 'view', 'details-id' => $value['transaksi_id'] ] ) ?>" class="btn btn-sm btn-success">Lihat</a>
												<?php echo sprintf( '<a href="javascript:void(0);" class="wp-remove-item" data-target="%s" data-toggle="tooltip" data-placement="top" title="Delete" data-original-title="Delete"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x-circle text-danger"><circle cx="12" cy="12" r="10"></circle><line x1="15" y1="9" x2="9" y2="15"></line><line x1="9" y1="9" x2="15" y2="15"></line></svg></a>', url( 'delete.transaction', array( 'id' => $value['transaksi_id'] ), array( 'wp_csrf_token' => csrf_token() ) ) ); ?>
											</td>
										</tr>
									<?php endforeach ?>
								<?php endif ?>
