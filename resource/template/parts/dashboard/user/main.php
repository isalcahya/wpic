		...
		<?php if ( ! $user->isEmpty() ):
			...
			<?php foreach ( $user as $key => $value ): ?>
				<tr>
					...
					<td> <?php echo get_role_name($value->roles_mask) ?> </td>
					<td>
